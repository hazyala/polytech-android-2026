package kr.ac.kopo.android.completetextviewtest;
...
public class MainActivity extends AppCompatActivity {
    ...
    String[] items = {"ball", "banana", "base", "balloon", "Canada", "carrot", "car", "card", "door"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        multiComplete = findViewById(R.id.multi_complete);
        ...
        multiComplete.setTokenizer(tokenizer);
